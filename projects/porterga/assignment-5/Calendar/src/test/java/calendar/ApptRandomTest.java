...
public class ApptRandomTest {
	...
	/**
	 * Return a randomly selected method to be tests !."setStartHour","setRecurrence", "setStartMinute", "setStartDay", "setStartMonth"
	 */
    public static String RandomSelectMethod(Random random){
        String[] methodArray = new String[] {"setRecurrence"};// The list of the of methods to be tested in the Appt class
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
			  ...
			  if(appt.getStartHour()>23 || appt.getStartHour()<0 || appt.getStartMinute()<0 || appt.getStartMinute()>59 || appt.getStartDay()<1){
